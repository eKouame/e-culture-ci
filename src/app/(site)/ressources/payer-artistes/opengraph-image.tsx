...
export const alt =
  "e-Culture CI — Déclarer et payer vos artistes correctement : retenue à la source, CNPS, statut de l'artiste.";
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <div style={{ display: "flex", fontSize: 24, color: "#6b6b6b" }}>
            e-culture-ci.vercel.app/ressources/payer-artistes
          </div>
        </div>
      </div>
    ),
