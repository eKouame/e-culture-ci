// Shared brand mark for opengraph-image.tsx routes (rendered via next/og's
// ImageResponse / Satori). Mirrors the avatar in public/avatar.svg — kept as
// inline SVG here (rather than an <img src>) because Satori needs the
// gradient/paths available synchronously at render time.
export function OgBrandBadge() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
      ...
      >
        ...
        >
          ...
          <g clipPath="url(#og-badge-clip)">
            <rect
              x="-7.73"
              y="-7.73"
              width="203.4"
              height="203.4"
              fill="url(#og-badge-gradient)"
            />
            <path
              fill="#fff"
